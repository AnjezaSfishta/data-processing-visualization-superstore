...
Qëllimi i këtij projekti është **përgatitja dhe vizualizimi i të dhënave** të shitjeve për të kuptuar më mirë performancën e biznesit.  
Më konkretisht, projekti fokusohet në:

### 1. Analiza e performancës së shitjeve sipas kategorive dhe rajoneve  
- Identifikimi i **produkteve dhe kategorive më fitimprurëse**  
- Analiza e **rajonit me më shumë volum shitjesh**  

### 2. Analiza e segmenteve të klientëve  
- Zbulimi i **segmenteve që sjellin më shumë të ardhura**  
- Krahasimi i **sjelljes së klientëve** në rajone të ndryshme  

### 3. Analiza kohore  
- Analizimi i trendeve të shitjeve përgjatë kohës  
- Krahasimi i **Order Date** dhe **Ship Date** për të llogaritur *Delivery Days*  
